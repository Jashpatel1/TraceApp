...
export default class App extends Component {
  ...
  traceProduct = async () => {
    ...
    try {
      await fetch(
        'https://cors-anywhere.herokuapp.com/vast-thicket-16737.herokuapp.com/api/trace',
        {
          method: 'POST',
          headers: {
  ...
  getAddress = async (traceArray) => {
    ...
    for (let i in traceArray) {
      await fetch(
        'https://cors-anywhere.herokuapp.com/vast-thicket-16737.herokuapp.com/api/user/getUser',
        {
          method: 'POST',
  ...
  set = (userArray) => {
    ...
    for (let i in userArray) {
      const ele = {
        ...
        description:
          'Address - ' +
          userArray[i].address.substring(0, 15) +
          '....\n' +
          'Phone - ' +
          userArray[i].phone +
          '\n',
  ...
  itemDisplay = (item, index) => {
    return (
      <View style={{ justifyContent: 'center', alignItems: 'center' }}>
        ...
        <Text style={{ fontSize: 18, paddingHorizontal: 20 }}>
          Address - {item.address.substring(0, 15)}....
        </Text>
      ...
      <View style={{ flex: 1, marginTop: StatusBar.currentHeight }}>
        ...
        <View style={{ flex: 1, marginTop: 30 }}>
          ...
          >
            ...
            >
              <Text style={{ fontSize: 15, color: '#eee', fontWeight: '400' }}>
                TRACE
              </Text>
            </View>
          </TouchableOpacity>
